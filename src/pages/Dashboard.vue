      ...
      <b-tabs position="is-centered" type="is-toggle" size="is-small" expanded>
          ...
          <b-table :data="bills">
            <template slot-scope="props">
              <b-table-column label="Date">{{
                new Date(props.row.dateTime).toLocaleString("en-SG")
              }}</b-table-column>
              <b-table-column label="Purpose">{{
                props.row.purpose
              }}</b-table-column>
              <b-table-column label="Total Amount">{{
        ...
        <b-tab-item label="Recent activities">
          <b-table :data="data" :selected.sync="selectedTransaction">
            <template slot-scope="props">
              <b-table-column label="Transaction Code">{{
                props.row.transactionCode
              }}</b-table-column>
              <b-table-column label="From">{{
                props.row.from.username
              }}</b-table-column>
              <b-table-column label="To">{{
                props.row.to.username
              }}</b-table-column>
              <b-table-column label="Date">{{
                props.row.date.toLocaleString("en-SG")
              }}</b-table-column>
              <b-table-column label="Purpose">{{
                props.row.purpose
              }}</b-table-column>
