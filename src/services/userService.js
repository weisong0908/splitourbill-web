...
export default {
  async getUserInfo(userId) {
    ...
    return axios.get(`${process.env.VUE_APP_Backend}/users/${userId}`, config);
  },
  ...
  async sendFriendRequest(requestorId, requesteeId) {
    ...
    return axios.post(
      `${process.env.VUE_APP_Backend}/friendships`,
      {
        requestorId,
        requesteeId
      },
  ...
  async getFriendRequests(requesteeId) {
    ...
    return axios.get(
      `${process.env.VUE_APP_Backend}/friendships/requests/${requesteeId}`,
      config
    );
  },
